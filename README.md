...
TÍTULO: TOTEM DE AJUDA À PESSOAS EM VULNERABILIDADE SOCIAL
   
    DESCRIÇÃO DO PROJETO:

 O "Totem de ajuda à pessoas em vulnerabilidade social" é uma ferramenta criada para facilitar a conexão entre pessoas em situação de vulnerabilidade social e os órgãos responsáveis pelo atendimento de cada necessidade específica.
